...
class GetCameraPage extends StatefulWidget {
  const GetCameraPage({Key? key}) : super(key: key);

  @override
  State<GetCameraPage> createState() => _GetCameraPageState();
}

class _GetCameraPageState extends State<GetCameraPage> {
